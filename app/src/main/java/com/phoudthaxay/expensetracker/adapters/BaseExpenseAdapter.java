package com.phoudthaxay.expensetracker.adapters;
...
public class BaseExpenseAdapter extends BaseExpenseRecyclerViewAdapter<BaseExpenseAdapter.BaseExpenseViewHolder> {
